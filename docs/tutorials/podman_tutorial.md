...
If you are running on a Mac or Windows PC, you should instead follow the [Mac and Windows tutorial](https://github.com/pycabbage/podman/blob/main/docs/tutorials/mac_win_client.md)
